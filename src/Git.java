...
public class Git {
    public static void main(String[] args) {
        ...
        if (flag) System.out.println("Git Repository Created Successfully");
        else System.out.println("Git Repository Creation Failed");
    ...
    public static boolean touch(File file) {
        if(existsFile(file)) return true;
        if(file.exists() && !file.isFile()) return false; // File exists but not a file
        try {
